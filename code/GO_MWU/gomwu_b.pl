...
my $gen2gobasename=basename($gen2go);
my $clfile="cl_dissim0_".$div."_".$gen2gobasename; 
...
unlink $clfile;
unlink "dissim0_".$div."_".$gen2gobasename; 
...
my $inname4="dissim_".$div."_".$gen2gobasename;
