...
KOGDcCc <- KOGheatmap(kogtables$Dc.Cc, kogpvals$Dc.Cc, main = "                     D-control vs. C-control", 
                      fontsize = 8)
ggsave(filename = "figures/FigS1.png", plot = KOGDcCc, width = 112, height = 84.5, units = "mm")
KOGChCc <- KOGheatmap(kogtables$Ch.Cc, kogpvals$Ch.Cc, main = "                     C-heated vs. C-control",
                      fontsize = 8)
ggsave(filename = "figures/FigS2.png", plot = KOGChCc, width = 112, height = 84.5, units = "mm")
KOGDhDc <- KOGheatmap(kogtables$Dh.Dc, kogpvals$Dh.Dc, main = "                     D-heated vs. D-control",
                      fontsize = 8)
ggsave(filename = "figures/FigS3.png", plot = KOGDhDc, width = 112, height = 84.5, units = "mm")
KOGDhCh <- KOGheatmap(kogtables$Dh.Ch, kogpvals$Dh.Ch, main = "                     D-heated vs. C-heated",
                      fontsize = 8)
ggsave(filename = "figures/FigS4.png", plot = KOGDhCh, width = 112, height = 84.5, units = "mm")
```
